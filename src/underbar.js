(function() {
  ...
  _.reduce = function(collection, iterator, accumulator) {
        var accum = arguments[2] !== undefined ? arguments[2] : collection.shift();
        
        _.each(collection, function(param){
          accum = iterator(accum, param)
        });
  ...
  _.every = function(collection, iterator) {
    ...
    var callback = iterator !== undefined ? iterator : _.identity;
    

    return _.reduce(collection, function(wasFound, item){
        return wasFound ? Boolean(callback(item)) : false;
    }, true);
  ...
  _.delay = function(func, wait) {
      ...
      setTimeout(function(){func(arg[2],arg[3])}, wait);
